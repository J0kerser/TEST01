...
module.exports = {
    ...
    SESSION: process.env.JOKER_SESSION === undefined ? '' : process.env.JOKER_SESSION,
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By JOKERSER' : process.env.ALL_CAPTION,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ JOKERSER ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
